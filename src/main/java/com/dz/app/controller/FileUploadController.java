...
//	public String handleUploadImage(@RequestParam("uploadImg") MultipartFile file) {
	public String handleUploadImage(@RequestParam("uploadImg") CommonsMultipartFile file,HttpSession httpSession,Model model) {
...
//		String targetFolder=realPath+file.getOriginalFilename();
		String targetFolder=realPath+"WEB-INF"+File.separator+"resources"+File.separator
				+"uploadFiles"+File.separator+file.getOriginalFilename();
