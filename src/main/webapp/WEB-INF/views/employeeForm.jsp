			...
			<form action="add" modelAttribute="EmployeeForm" method="post">
				<div class="container">
					...
					<div class="row">
						<div class="col">
							<input
								type="text" class="form-control inpSty" name="birthDate" placeholder="Date Of Birth"
						...
						<div class="col">
							...
							<div>
								<span class="form-check"> <input class="form-check-input"
									type="radio" name="gender"value="M"  id="flexRadioDefault1" checked>
					...
					<div class="row">
						<div class="col-12">
							<button type="submit" class="btn btn-outline-primary" onClick="return checkform()">Submit</button>
